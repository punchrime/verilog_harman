...
HD_PWD='D:/rime/fpga/241113/mux_test/mux_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_41_if.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_41_if.tcl
